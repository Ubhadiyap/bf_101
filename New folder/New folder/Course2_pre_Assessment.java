...
public class Course2_pre_Assessment extends Activity implements View.OnClickListener, Animation.AnimationListener {
	...
	private void random() {
		...
		if (rand_int.contains(random)) {
			...
			if (question_no == 5) {
				...
				Intent it = new Intent(this, Course2_introduction.class);
