...
public class Course5_quiz extends Activity implements View.OnClickListener, Animation.AnimationListener {
	...
	private void add_to_database() {
		...
		Cursor c = newDB.rawQuery(Course_database.select_all("course5_database"), null);
	...
	private void add_to_database3() {
		...
		Course_database.add_to_database(username, user_id, new_attempt, new_failed, new_success, new_total_score, pre_ass_score,
				String.valueOf(score*20), status, "course5_database");
